  ...
  <body>
    <?php 
      ...
      if (!empty($_SESSION["username"]) && $_SESSION["username"] === "admin"){
        echo ('<h3 class="d-flex justify-content-center">I guess you are cool enough to be an admin</h3><h2 class="d-flex justify-content-center">DVPW{F1l7er_70uR_L06IN$}</h2><h4 class="d-flex justify-content-center">I store my logs for everyone to see! it\'s at /logs/php.log</h4><!-- My user agent, totally not vulnerable *wink wink* --><p class="d-flex justify-content-center"> My user agent: '.$_SERVER['HTTP_USER_AGENT']??null.'</p>');
      } else {
